...
export default function Home() {
  return (
      <section className="bg-[#e1edd0] text-white font-belgrano">
        <div className="mx-auto px-4 py-32 pt-16 max-w-[80rem] lg:flex lg:h-[90vh] lg:items-center">
          <div className="mx-auto w-full text-center">
              <h1
                  className="bg-[#080b05] bg-clip-text text-4xl font-belgrano font-bold text-transparent sm:text-4xl"
              ...
              <div className="mt-8 flex flex-wrap justify-center gap-4">
                  <a
                      ...
                      hover:text-black group font-belgrano"
                  ...
                  >
                      ...
                      <span className="relative group-hover:text-gray-800 font-belgrano text-xl leading-none">
                          Resume
                      </span>
                  </a>
                  <a
                      ...
                      hover:text-white group font-belgrano"
