...
export default function Home() {
  return (
      <section className="bg-gray-900 text-white">
        <div className="mx-auto max-w-screen-l px-4 py-32 lg:flex lg:h-[60vh] lg:items-center">
          <div className="mx-auto lg:max-w-md text-center max-w-2xl">
            <h1
                className="bg-gradient-to-r from-green-300 via-blue-500 to-purple-600 bg-clip-text text-3xl font-arsmaquette text-transparent sm:text-3xl"
            >
              Hi, I'm Jay!
                <span className="sm:block"> Full-Stack Go & Python Developer </span>
            </h1>
              <p className="mx-auto mt-4 max-w-0.5xl sm:text-1xl/relaxed">
                  Software Engineer @ Easy Meets
              </p>
              <p className="mx-auto mt-0 max-w-0.5xl sm:text-1xl/relaxed">
                  CS + Applied Math @ the City College of New York
              </p>
              <div className="mt-8 flex flex-wrap justify-center gap-4">
                  ...
                  <a
                      className="relative flex items-center justify-center w-full rounded-sm border border-gray-800 bg-gray-800 px-10 py-5 text-sm font-medium text-white overflow-hidden transition-all duration-300 ease-in-out sm:w-auto
                      hover:text-black group"
