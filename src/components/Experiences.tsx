...
export default function Experiences() {
  return (
    ...
    >
      <div className="mb-8">Experiences</div>
          ...
          <div className="text-[27px] text-[#1591ea]">
            ...
            <div className="text-[20px] text-[#000000]">
              <ul className="list-disc font-arsmaquette">
                <li>
                  Receive mentorship and coaching for technical prep and mock
                  interviews
                </li>
                <li>
                  Develop skills in data science technologies including Pandas,
                  TensorFlow, PyTorch in weekly courses
                </li>
              </ul>
            </div>
          </div>
        ...
        <div>
          ...
          <div className="text-[27px] text-[#1591ea]">
            ...
            <div className="text-[20px] text-[#000000]">
              <ul className="list-disc font-arsmaquette">
                <li>
                  Develop full-stack applications integrated with AI libraries
                  throughout 7 weeks and participate in weekly hackathons
                </li>
              </ul>
            </div>
          </div>
