    ...
    return (
        <main id="Projects"
            ...
            <div className="flex justify-center flex-wrap mt-[20px] ">
                <div
                    ...
                    <div className="p-[16px] flex-grow"> {}
                        ...
                        <p className="text-gray-600 text-[15px] leading-tight font-arsmaquette">
                            A web application built with <strong>Next.JS</strong> and <strong>SQL</strong> to ensure a smooth enrollment process into university courses.
                ...
                <div
                    className="w-[325px] bg-[#f0f0f0] border-r-[8px] overflow-hidden m-[20px] shadow-customShadow flex flex-col"> {}
                    <img src="/dovelop-cli.gif" className="w-[100%] h-[200px]" alt="Dovelop AI"/>
                    <div className="p-[16px] flex-grow"> {}
                        <h3 className="text-[28px] mb-[8px]">Dovelop AI</h3>
                        <p className="text-gray-600 text-[15px] leading-tight font-arsmaquette">
                            A CLI to do list application made to improve productivity for developers and other users.
                            Be able to track your to do list and edit them in real time while you are working on a project!
                            Dovelop is powered by <strong>Go</strong>, uses <strong>OpenAI</strong> for task breakdowns, and local JSON data to store to do list data
                        </p>
                    </div>
                    {}
                    <div className="flex items-center justify-between mt-auto"> {}
                        <a href="https://github.com/jaynopponep/dovelop-CLI" target="_blank"
                           className="ml-2 inline-block px-[8px] py-[8px] bg-gray-800 text-white no-underline rounded text-sm">
                            <IoLogoGithub style={{fontSize: '36px'}}/>
                        </a>
                ...
                <div
                    ...
                    <div className="p-[16px] flex-grow"> {}
                        ...
                        <p className="text-gray-600 text-[15px] leading-tight font-arsmaquette">
                            A website built with Next.JS to showcase CCNY's BYTE Club website, its projects, and its
                            eboard.
                        </p>
                    </div>
                    {}
                ...
                <div
                    ...
                    <div className="p-[16px] flex-grow"> {}
                        ...
                        <p className="text-gray-600 text-[15px] leading-tight font-arsmaquette">
                            ...
                            with <strong>NextJS</strong>, <strong>Flask</strong>, and <strong>MongoDB Atlas</strong>.
                        </p>
                    </div>
                    {}
                    <div className="flex items-center justify-between mt-auto"> {}
