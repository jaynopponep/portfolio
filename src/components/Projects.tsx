    ...
    return (
        <main id="Projects"
            ...
            <div className="flex justify-center flex-wrap mt-[20px] ">
                <div className="w-[325px] bg-[#f0f0f0] border-r-[8px] overflow-hidden m-[20px] shadow-customShadow flex flex-col"> {/* Added 'flex flex-col' */}
                    <img src="/schedule_snake.gif" className="w-[100%] h-[200px]" alt="Schedule Snake"/>
                    <div className="p-[16px] flex-grow"> {/* Added 'flex-grow' */}
                ...
                <div
                    className="w-[325px] bg-[#f0f0f0] border-r-[8px] overflow-hidden m-[20px] shadow-customShadow flex flex-col"> {/* Added 'flex flex-col' */}
                ...
                <div className="w-[325px] bg-[#f0f0f0] border-r-[8px] overflow-hidden m-[20px] shadow-customShadow flex flex-col"> {/* Added 'flex flex-col' */}
                    ...
                    <div className="p-[16px] flex-grow"> {/* Added 'flex-grow' */}
                        ...
                        <p className="text-gray-600 text-[15px] leading-tight font-arsmaquette">
                            ...
                            with NextJS, Flask, and MongoDB Atlas.
                        </p>
                    </div> {/* End of 'flex-grow' section */}
                    <div className="flex items-center justify-between mt-auto"> {/* Added 'mt-auto' */}
